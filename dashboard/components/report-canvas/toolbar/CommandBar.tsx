...
export function CommandBar(props: Props) {
  ...
  return (
    <div className="flex h-11 items-center justify-between gap-2 border-b border-slate-200 bg-white px-3 shrink-0">
      ...
      {/* ── CENTRE: view controls (compressible — never pushes the right zone off-screen) ── */}
      <div className="flex min-w-0 shrink items-center gap-2 overflow-x-auto scrollbar-none">
      ...
      {/* ── RIGHT: actions (shrink-0 — these critical buttons must always be visible) ── */}
      <div className="flex shrink-0 items-center gap-2">
        {/* Bundle progress pill → Control Panel */}
        <button onClick={onOpenControlPanel} title="Control Panel" className="hidden items-center gap-1.5 rounded-full bg-slate-100 px-2.5 py-1 hover:bg-slate-200 sm:flex">
