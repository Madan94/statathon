...
def run_semantic_pipeline(columns: list[str], column_enrichment: dict[str, str] | None = None) -> dict:
    ...
    return pipeline.run(columns, column_enrichment=column_enrichment)
