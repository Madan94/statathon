...
DEFAULT_SYNONYMS: dict[str, list[str]] = {
    "labour_force":  ["lfpr", "labour force", "labor force", "labour_force",
                      ...
                      "wpr", "worker_population", "worker population ratio",
                      "usual status", "current weekly status", "cws", "ps_ss",
                      "activity status", "self employed", "regular wage",
                      "casual labour"],
    "unemployment":  ["unemployment", "ur", "joblessness", "unemployed",
    ...
    "energy":        ["reserves", "proved", "indicated", "inferred",
                      ...
                      "lignite", "crude oil", "refinery", "installed capacity",
                      "generation", "gwh", "bcm", "mt", "mmt", "mtoe",
                      "nuclear", "geothermal", "tidal"],
    "trade":         ["import", "export", "trade", "balance", "bop",
                      "tariff", "forex", "fdi", "fii", "commodity",
                      "merchandise", "services trade"],
    "finance":       ["cpi", "wpi", "inflation", "price index", "interest",
                      "repo", "gdp", "fiscal deficit", "revenue deficit",
                      "money supply", "credit", "deposit", "npa"],
    "time":          ["year", "month", "quarter", "fiscal_year", "fy",
                      "reporting", "date", "period", "survey round",
                      "annual", "quarterly"],
    "growth":        ["growth", "delta", "change", "yoy", "yoy_change",
                      "cagr", "increase", "decrease", "improvement"],
    "ratio":         ["ratio", "rate", "pct", "percentage", "share",
                      "proportion", "distribution", "per 1000", "per lakh"],
    "ranking":       ["rank", "top", "bottom", "highest", "lowest"],
    "vulnerability": ["vulnerable", "exposure", "risk"],
    "economic_shock":["shock", "downturn", "recession", "crisis", "stress"],
    "estimate_status": ["provisional", "revised", "final", "quick",
                        "advance", "first revised", "second revised"],
}
